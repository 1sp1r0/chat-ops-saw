var HttpsProxyAgent, Bot, Channel, Client, DM, EventEmitter, Group, Log, Message, Team, User, WebSocket, https, querystring,
...
Client = (function(_super) {
  ...
  function Client(token, autoReconnect, autoMark, proxyUrl) {
    ...
    this.proxyUrl = proxyUrl || process.env.http_proxy;
  ...
  Client.prototype.connect = function() {
    if (!this.socketUrl) {
      ...
      var options = this.proxyUrl && { agent: new HttpsProxyAgent(this.proxyUrl) };
